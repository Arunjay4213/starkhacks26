...
Requires ANTHROPIC_API_KEY in env or .env. Model picked via MONDAY_CLAUDE_MODEL
...
os.environ.setdefault("MONDAY_CLAUDE_MODEL", "claude-haiku-4-5-20251001")
...
def main() -> int:
    ...
    print(f"model: {os.environ['MONDAY_CLAUDE_MODEL']}")
