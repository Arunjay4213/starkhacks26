...
in the same order of magnitude so the existing MONDAY_VAD_THRESHOLD tuning
still works.
"""
...
def test_default_vad_threshold_lands_between() -> None:
    """The default MONDAY_VAD_THRESHOLD (500) should split silence and moderate speech."""
