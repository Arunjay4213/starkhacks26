...
Sinew hardware bridge. Not part of the live demo. Operators use this tool
...
class CalibrationWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Sinew Calibration")
        self.resize(760, 640)

        self._http = HttpClient(self)
        self._http.finished.connect(self._on_http_result)
        self._http.set_base_url(os.environ.get("SINEW_RECEIVER_URL", DEFAULT_BASE_URL))
